...
analysis of daily load trajectories. Another current limitation is that K-means
uses static flexibility features; future work may replace or augment this with
learned embeddings based on building trajectories.
