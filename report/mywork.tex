...
评估工具能够统一导出测试月指标、排序表和负荷跟踪图。
这说明项目已经不再只是前期流程调试，
而是可以在同一个 MAPPO 框架下对多个基线和通信变体进行完整比较。
...
在当前选定的基准结果集中，
\texttt{mappo\_grouped\_comm\_v2\_vt\_500\_final} 是整体表现最强的方法；
TarMAC、\mbox{$\alpha=0.90, \beta=0.10$} 的加权通信和 GAT 也表现出有竞争力的权衡。
