...
本报告中的 reward function 只围绕三个主要目标设计，而次要指标只用于评估分析，不直接进入优化目标。

The core research question is:

\begin{quote}
In the CityLearn portfolio load tracking task, what kinds of MARL structures
and communication designs are more effective, and why are they effective?
\end{quote}

中文：核心研究问题是：在 CityLearn 组合负荷跟踪任务中，
什么样的 MARL 结构和通信设计更有效，以及它们为什么有效？
...
\texttt{target\_folder} outputs. The project can support a mature comparison of
load tracking, comfort, peak demand, fairness, and communication design. In the
current Vermont results, the strongest overall method is
...
here is a completed benchmark set.
