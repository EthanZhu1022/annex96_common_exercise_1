...
The evaluation considers not only load tracking error, but also indoor comfort and secondary metrics such as cost, carbon emissions, total energy use, peak demand, peak-to-valley ratio, load factor, ramping, and fairness.
...
independent building controllers with MARL controllers to test whether
coordination is actually useful for CE1. Second, it compares different MARL
choices, such as MAPPO, MASAC, or value-based methods, to understand which
learning style is more suitable for this task. Third, it compares MAPPO
variants with and without communication, and then compares different
