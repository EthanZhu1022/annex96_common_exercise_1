"""
Grouped MAPPO with hybrid TarMAC-style global communication and grouped actor heads.
...
from mappo_grouped_tarmac_hybrid.cluster import run_clustering  # noqa: E402
from mappo_grouped_tarmac_hybrid.env import CityLearnMAPPOEnv  # noqa: E402
...
class Config:
    ...
    wandb_name: str = "mappo-grouped-tarmac-hybrid"
    save_dir: str = "results/mappo_grouped_tarmac_hybrid"
...
def train(cfg: Config) -> None:
    ...
    print("\nGrouped MAPPO TarMAC hybrid training complete.")
...
def parse_args() -> Config:
    parser = argparse.ArgumentParser(
        description="Grouped MAPPO with hybrid TarMAC-style global communication and grouped actor heads."
    )
    ...
    parser.add_argument("--wandb_name", default="mappo-grouped-tarmac-hybrid")
    parser.add_argument("--save_dir", default="results/mappo_grouped_tarmac_hybrid")
