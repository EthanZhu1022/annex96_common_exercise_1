        ...
        **kwargs,
        ...
        for k, v in kpis.items():
            ...
            if scalar is not None:
                episode.custom_metrics[k] = scalar
...
def _run_daily_pipeline(
    ...
    temperature_csv, temperature_full_fig, temperature_week_fig = export_building_temperature_artifacts(
        ...
        cfg.climate,
        month_name,
        algorithm_label="RLlib SAC Temperatures",
    )
...
def evaluate_on_test(
    ...
    result: Dict = {
        ...
        **{f"test/{k}": v for k, v in test_soc.items()},
        ...
        "_building_temperature_timeseries": collect_building_temperature_timeseries(test_env_obj.base_env).to_dict(orient="records"),
    }
