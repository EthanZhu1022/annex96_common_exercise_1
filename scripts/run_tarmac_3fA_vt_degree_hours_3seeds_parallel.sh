...
LOG_DIR="$REPO_DIR/experiment_queue_logs/vt_3fA_comfort15_binary30_degree15_$STAMP"
mkdir -p "$LOG_DIR"
...
run_seed() {
  ...
  local run_name="mappo_grouped_tarmac_hybrid_agglomerative_capacity_load_3f_linear_vt_500_nmbe1_cvrmse1_comfort15_binary30_degree15_seed${seed}"
